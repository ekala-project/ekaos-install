...
pub fn get_locale_list() -> Vec<(String, String)> {
    vec![
        ...
        (
            ...
            "English (New Zealand)".to_string(),
        ),
        (
            "en_ZA.UTF-8".to_string(),
            "English (South Africa)".to_string(),
        ),
        ...
        (
            "de_CH.UTF-8".to_string(),
            "German (Switzerland)".to_string(),
        ),
        ...
        (
            "fr_CH.UTF-8".to_string(),
            "French (Switzerland)".to_string(),
        ),
        ...
        (
            "pt_PT.UTF-8".to_string(),
            "Portuguese (Portugal)".to_string(),
        ),
